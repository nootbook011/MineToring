...
API которое изменяется в зависимости от версии протокола такие как данные внутри классов хранилищ и некоторые плагины.

---

## Bots

### [CustomPClient](./API/CustomPClient.md)
